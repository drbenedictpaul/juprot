...
# !!! Main.UserApp is configured as an alias for Main.JuProtGUI and you might encounter it in some tests
using Main.JuProtGUI, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuProtGUI tests" begin
  @includetests ARGS
end
